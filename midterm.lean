...
AddTorsor.mk.{u_2, u_1}
  {G : outParam (Type u_1)}
  {P : Type u_2} [inst✝ : outParam (AddGroup G)]
...
instance : Nonempty State := Nonempty.intro s0
...
theorem rot_add_identity: ∀ (a : Rotation), 0 + a = a :=
by
  intros a 
  cases a 
  repeat {rfl}
